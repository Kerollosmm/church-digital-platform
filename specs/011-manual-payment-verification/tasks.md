...
- [ ] T008 [P] [US1] Register in `supabase/tests/run_all.sql`; run `node scripts/test-sql.js` confirm 0067 FAILS (red)
...
- [ ] T011 [US1] Run `npx supabase db reset` + `node scripts/test-sql.js` — 0067 green; commit `feat(sql): 0067 owner-only payment proof submission`
