                            ...
                            Row(
                              children: [
                                CircleAvatar(
                                  ...
                                  child: Icon(
                                    cert.sacramentType == SacramentType.marriage
                                        ? Icons.favorite
                              ...
                              children: [
                                Row(
                                  children: [
                                    ...
                                    Text(
                                      '${cert.sacramentDate.year}-${cert.sacramentDate.month.toString().padLeft(2, '0')}-${cert.sacramentDate.day.toString().padLeft(2, '0')}',
                                      style: const TextStyle(
                                        fontSize: 12,
