...
class PayoutsConfigScreen extends ConsumerStatefulWidget {
  const PayoutsConfigScreen({super.key, this.repo, this.isSuperAdminOverride});

  final PaymentsAdminRepository? repo;
  final bool? isSuperAdminOverride;

  @override
  ConsumerState<PayoutsConfigScreen> createState() =>
      _PayoutsConfigScreenState();
}
                ...
                children: [
                  ...
                  TextField(
                    ...
                    decoration: const InputDecoration(
                      labelText: 'اسم الوسيلة بالعربية',
                    ),
                  ),
                  ...
                  TextField(
                    ...
                    decoration: const InputDecoration(
                      labelText: 'اسم صاحب المحفظة / الحساب',
                    ),
                  ),
                ],
              ),
                        ...
                        res.fold(
                          ...
                          (_) {
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(
                                content: Text(
                                  'تم تحديث بيانات وسيلة الدفع بنجاح',
                                ),
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                const Text(
                                  'اسم المستلم / صاحب الحساب: ',
                                  style: TextStyle(color: Colors.white60),
                                ),
                                Text(
                                  ch.holderName.isEmpty
                                      ? 'غير محدد'
                                      : ch.holderName,
                                  style: const TextStyle(
