...
void main() {
  testWidgets('AttendanceChartWidget queries v_analytics_utilization and renders BarChart with legend and Arabic labels', (tester) async {
  ...
  testWidgets('AttendanceChartWidget renders empty message when v_analytics_utilization returns no rows', (tester) async {
    final fakeDb = FakeSupabase({
      'v_analytics_utilization': [],
    });
  ...
  testWidgets('AttendanceChartWidget surfaces friendly error message on fetch failure', (tester) async {
    await tester.pumpWidget(
      MaterialApp(
        home: Scaffold(
          body: AttendanceChartWidget(
