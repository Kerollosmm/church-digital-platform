...
void main() {
  testWidgets(
    'ComplaintsAdminScreen renders complaint list from v_complaints and decrypts body on demand',
    (tester) async {
      final mock = MockSupabase(
        ...
        rpc: {
          'decrypt_complaint': (args) async => {
            'decrypted': 'محتوى الشكوى السري المفكوك',
          },
        },
      );
      ...
      expect(
        mock.requestLog.any((p) => p.endsWith('/rpc/decrypt_complaint')),
        isTrue,
      );
